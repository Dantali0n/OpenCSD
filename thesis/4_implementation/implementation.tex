...
\footnotetext[13]{UNIX error codes are used to indicate the types of failure
...
% Setting up uBPF VM and registering hooks for call instructions
% explain trapping into vendor controlled code without having to have access
% to firmware / source in any shape or form.

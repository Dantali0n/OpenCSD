...
conditions which are not re-evaluated when executing the generated makefile.}
...
\footnotetext[12]{While alternative technologies to implement filesystems exist
...
In a very high level overview the data layout of FluffleFS is spread across
...
Our design moved from the development of an accelerator API to an artificial

...
\begin{frame}{Why do we need it}
    \begin{columns}
        ...
        \begin{column}{0.7\textwidth}
            ...
            \begin{figure}
                \centering
                \includegraphics[width=0.92\textwidth]{resources/images/storage-bottleneck.png}
            \end{figure}
            \endgroup
        \end{column}
    \end{columns}
...
\begin{frame}{State of Current Prototypes (September 2022)}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            ...
            \footnotesize
            \begin{itemize}
                \item BlockNDP (2020) \footnotemark[1]
                \item Metal FS (2020) \footnotemark[2]
                \item INSIDER (July 2019) \footnotemark[3]
            \end{itemize}
        \end{column}
        \begin{column}{0.5\textwidth}
            Impediments:
        ...
        \end{column}
    \end{columns}
    \footnotetext[1]{\tiny https://doi.org/10.1145/3429357.3430519}
    \footnotetext[2]{\tiny https://doi.org/10.1145/3342195.3387557}
    \footnotetext[3]{\tiny https://www.usenix.org/conference/atc19/presentation/ruan}
\end{frame}
\note{
}

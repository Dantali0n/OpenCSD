...
Clion -> Library header inspection

Vscode -> On guest debugging through SSH

% backtraces with backward-cpp
% debugging on the remote in vscode
% searching through libraries and headers in clion

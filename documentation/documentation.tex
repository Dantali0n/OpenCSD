...
API available to the programs running on the CSD.
...
predictions based on theorized bus and device bandwidth.
...
retrieve the return data of the BPF program after it has finished executing.
...
list that maintains all instances of \textit{NvmCsd} would be used.
